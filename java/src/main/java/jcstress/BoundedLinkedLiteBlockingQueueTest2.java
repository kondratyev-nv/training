...
@Outcome(id = "2, 1", expect = Expect.ACCEPTABLE, desc = "Default outcome.")
@State
public class BoundedLinkedLiteBlockingQueueTest2 {
    private BlockingQueue<Integer> q = new BoundedLinkedBlockingQueue<>(2);
